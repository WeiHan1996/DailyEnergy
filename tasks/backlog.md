...
| S-03 | 交互状态与页面规格 | In Progress | screen-specs、interaction-states、content-layout | S-02 |
...
| ID | 任务 | 状态 | 主要交付 | 依赖 |
|---|---|---|---|---|
| S-05 | 产品状态机 | Planned | docs/product/state-machine.md | S-03 |
...
| ID | 任务 | 状态 | 主要交付 | 依赖 |
|---|---|---|---|---|
| S-10 | 稳定种子与产品日期决策 | Planned | ADR-0002 | S-05 |
...
| ID | 任务 | 状态 | 主要交付 | 依赖 |
|---|---|---|---|---|
| S-17 | 领域模型 | Planned | domain-model.md | S-05～S-09、S-14 |
...
| ID | 任务 | 状态 | 主要交付 | 依赖 |
|---|---|---|---|---|
| S-24 | 埋点事件字典 | Planned | event-tracking.md | S-02、S-05、S-20 |
| S-25 | 指标唯一口径 | Planned | metrics.md | S-24 |
