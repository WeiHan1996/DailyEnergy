...
- **当前任务**：[C-015 统一审核修复](./current.md)：[Draft PR #169](https://github.com/WeiHan1996/DailyEnergy/pull/169) 已通过 owner 代码/threat-boundary 审核，等待外部证据与 stacked merge 策略；所有现有 PR 保持 Draft、Issue 保持 Open
...
| [C-014](https://github.com/WeiHan1996/DailyEnergy/issues/65) | 数据查看与删除     | In Review | [Draft PR #167](https://github.com/WeiHan1996/DailyEnergy/pull/167)；final-head 11/11 CI；等待统一审核                                                 |
| [C-015](https://github.com/WeiHan1996/DailyEnergy/issues/68) | 统一审核修复       | In Review | [Draft PR #169](https://github.com/WeiHan1996/DailyEnergy/pull/169)；owner code/threat review PASS，外部证据/merge 策略 Pending；#157～#168 保持 Draft |
