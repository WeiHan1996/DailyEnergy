...
- **当前任务**：[C-013 七天趋势](./current.md)正在 `agent/c013-seven-day-trends` 实现；C-004～C-012 已完成 stacked Draft PR、自动 Gate 与 final-head 11/11 CI，等待 C-015 后统一审核
...
| [C-013](https://github.com/WeiHan1996/DailyEnergy/issues/70) | 七天趋势           | In Progress | 真实数据和缺失处理；stacked branch `agent/c013-seven-day-trends`                                 |
