...
| [E-011](https://github.com/WeiHan1996/DailyEnergy/issues/48)  | CI                                         | Blocked | 复核修复待 Linux Gate；retention 与 required checks 阻塞 |
...
人工边界复核已在 Draft PR #119 通过；代码复核修复等待新的 Linux clean run，随后仍因 365 天
artifact retention 和私有仓库当前计划不支持 branch protection required checks 两项外部条件而 Blocked；实现分支为
