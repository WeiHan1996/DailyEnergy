...
- **当前任务**：[C-014 数据查看与删除](./current.md)已创建 [Draft PR #167](https://github.com/WeiHan1996/DailyEnergy/pull/167)，等待 final-head CI；C-004～C-013 已完成 stacked Draft PR、自动 Gate 与 final-head 11/11 CI，等待 C-015 后统一审核
...
| [C-014](https://github.com/WeiHan1996/DailyEnergy/issues/65) | 数据查看与删除     | In Review | [Draft PR #167](https://github.com/WeiHan1996/DailyEnergy/pull/167)；自动 Gate 完成，等待 final-head CI |
