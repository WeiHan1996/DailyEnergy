...
- **当前任务**：[C-014 数据查看与删除](./current.md)正在 `agent/c014-data-rights` 实现；C-004～C-013 已完成 stacked Draft PR、自动 Gate 与 final-head 11/11 CI，等待 C-015 后统一审核
...
| [C-014](https://github.com/WeiHan1996/DailyEnergy/issues/65) | 数据查看与删除     | In Progress | 用户权利闭环；stacked branch `agent/c014-data-rights`                                                  |
