...
- [D-004 Prototype / QA / Developer Handoff](./developer-handoff.md) — Accepted by project owner / PR #145 merged
- [D-005 Phase 2 剩余页面高保真 / Handoff](./phase2-remaining-handoff.md) — Draft / In Review
...
| [D-004 #102](https://github.com/WeiHan1996/DailyEnergy/issues/102) | Done | [developer-handoff.md](./developer-handoff.md) | Prototype、异常恢复、Visual QA、开发证据合同；PR #145 已合并 |
| [D-005 #104](https://github.com/WeiHan1996/DailyEnergy/issues/104) | In Review | [phase2-remaining-handoff.md](./phase2-remaining-handoff.md) | 晚间、趋势、删除 / 导出、数据权利与注销高保真及开发交付 |
...
- D-005 被项目负责人明确接受前，C-012、C-013、C-014 不得开始对应正式页面实现；
- `phase2-remaining-handoff.md` 当前仍是 Draft，Figma / Prototype / Visual QA 完成不自动等于 Accepted；
- Safety 继续复用 Accepted SAFE-001 与既有安全响应合同；
- 外部 5～8 人研究、微信平台 / 真机与 Production / RC Gate 继续遵守各自独立授权和证据边界。
