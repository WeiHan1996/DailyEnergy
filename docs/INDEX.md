...
| [tests/README.md](../tests/README.md)                                                                                                                                                                  | Active      | E-010 registry/harness、E-011/E-016 CI/仓库控制、E-013/E-014 Gate、E-017 DEV_LITE 与 AI-005 人格 corpus 证据入口                                  | testing、deployment、现有 DB/queue/API/Admin/miniapp evidence |
| [Phase 1](https://github.com/WeiHan1996/DailyEnergy/milestone/1) / [Phase 2](https://github.com/WeiHan1996/DailyEnergy/milestone/2) / [Phase 3](https://github.com/WeiHan1996/DailyEnergy/milestone/3) | Active      | 54 个 Issues 绑定三个真实 Milestone；AI-005 PR #195 已合并，当前先修复 merged-main supply-chain SHA 误报再启动 AI-006；C-015 外部证据独立 Blocked | Accepted Phase 0B/1/2 specs、Phase 2 Gate、AI-005 #74         |
...
Phase 0B、Phase 1 和 Phase 2 已结束；D-001～D-005、E-001～E-017、C-001～C-014/C-016/C-017 与 AI-001～AI-004 已完成。AI-005 PR #195 已合并且 Issue #74 已关闭；merged-main supply-chain 因 merge SHA 中的数字片段触发手机号误报，当前以紧急 CI Gate 修复中断 AI-006 启动。C-015 的 Production/Privacy/Legal 外部证据继续 Blocked，Production/RC 保持 `NO_GO`。读取顺序：
