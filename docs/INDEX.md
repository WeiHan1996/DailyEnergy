...
| [docs/ai/memory-enabled-daily-v2.md](./ai/memory-enabled-daily-v2.md) | Draft    | Daily v2 记忆表达位置、版本、严格引用与同候选回退提案               | ADR-0004、memory、daily-content、prompt、safety       |
...
| [docs/operations/privacy-notice.html](./operations/privacy-notice.html)                             | Draft       | “见见今天”网页隐私政策候选文本；未生效且待生产事实与法律审核                       | privacy-data-map、MVP、C-015                          |
...
| [docs/operations/development-deployment-runbook.md](./operations/development-deployment-runbook.md) | Accepted    | 标准 DEV 历史流程与 DEV_LITE publication、阶段发布、reconciliation、回滚和换机恢复 | deployment、testing、ADR-0007、ADR-0009               |
...
| [tests/README.md](../tests/README.md)                                                                                                                                                                  | Active      | E-010 registry/harness、E-011/E-016 CI/仓库控制、E-013/E-014 Gate、E-017 DEV_LITE 与 AI-005～AI-008 确定性证据入口 | testing、deployment、现有 DB/queue/API/Admin/miniapp evidence |
| [Phase 1](https://github.com/WeiHan1996/DailyEnergy/milestone/1) / [Phase 2](https://github.com/WeiHan1996/DailyEnergy/milestone/2) / [Phase 3](https://github.com/WeiHan1996/DailyEnergy/milestone/3) | Active      | 54 个 Issues 绑定三个真实 Milestone；AI-008 已完成，AI-009 是唯一 Ready；C-015 外部证据独立 Blocked                | Accepted Phase 0B/1/2 specs、Phase 2 Gate、AI-009 #78         |
...
| [ADR-0007-development-colocation-exception.md](./decisions/ADR-0007-development-colocation-exception.md)           | Superseded | 腾讯云标准 DEV 历史同机 PostgreSQL/Redis、私有 COS 与退出边界             | 已由 ADR-0009 取代 |
...
| [ADR-0009-development-lite-colocation-exception.md](./decisions/ADR-0009-development-lite-colocation-exception.md) | Accepted   | 阿里云 2C2G DEV_LITE、阶段启停、本地 synthetic object 与 Production NO_GO | E-017 开工前       |
...
Phase 0B、Phase 1 和 Phase 2 已结束；D-001～D-005、E-001～E-017、C-001～C-014/C-016/C-017 与 AI-001～AI-008 已完成。AI-009 是唯一 Ready，等待新的明确启动指令，本次不运行 prepare 或实现。C-015 的 Production/Privacy/Legal 外部证据继续 Blocked，Production/RC 保持 `NO_GO`。读取顺序：
