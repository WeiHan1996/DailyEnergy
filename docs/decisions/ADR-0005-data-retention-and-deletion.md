...
- PR：[#21](https://github.com/WeiHan1996/DailyEnergy/pull/21)；
- 接受状态：Accepted（用户确认后已 squash 合并）；
- 接受日期：2026-07-22；
- 合并提交：`31eb8cc1c4fe90bef6f73471779d255bdb34c012`；
- 接受范围：期限表、24 个月无使用、DAY guard 与同日重记、关系删除默认范围、72 小时在线清理、35 天备份、provider 30 天硬门和受限证据；
- 当前任务：S-19 数据库规格与 Prisma 草案。
